<div>
    ...
    <div class="bg-black text-green-400 font-mono p-6 max-w-md mx-auto space-y-6 border-2 border-[#458B41] shadow-lg">
            ...
            <div>
                ...
                <?php if (count($added_languages_clean) > 0): ?>
                <?php foreach($added_languages_clean as $key=>$val): ?>
                    ...
                    <?php endforeach; ?>
                <?php else: ?>
                    <option value="0" selected disabled>No languages added</option>
                <?php endif; ?>
                </select>
            </div>
            ...
            <div>
                ...
                <?php if (count($added_categories_clean) > 0): ?>
                ...
                <?php endforeach; ?>
                <?php else: ?>
                    <option value="0" selected disabled>No words added</option>
                <?php endif; ?>
                </select>
            </div>
     ...
     <?php if (isset($_SESSION['quiz_msg'])): ?>
        <div class="max-w-md mx-auto bg-black border border-[coral] text-[coral] px-4 py-3 mt-6 font-mono" role="alert">
            ...
            <span class="block sm:inline">
                You have not added any words in this language (<span class="opacity-60"><?= ucwords($_SESSION['quiz_msg'][0]) ?></span>) or category (<span class="opacity-60"><?= $_SESSION['quiz_msg'][1] === 'all' ? 'All' : ucwords(str_replace('_', ' ', $_SESSION['quiz_msg'][1])) ?></span>), <b><u>OR</u></b> their next review is not yet due.<br>> Add more words to practice now.
            </span>
